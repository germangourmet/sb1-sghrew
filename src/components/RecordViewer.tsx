...
import { X, Download, Globe, Building2, Mail, Phone, Hash, FileText, CheckCircle, AlertCircle, TrendingUp } from 'lucide-react';
          ...
          <div className="grid grid-cols-2 gap-8 font-mono">
            ...
            <div className="space-y-6">
              ...
              {record.images && record.images.length > 0 && (
                <div className="space-y-2">
                  <div className="text-green-500/70">IMAGES:</div>
